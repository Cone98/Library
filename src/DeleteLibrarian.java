...
public class DeleteLibrarian extends JFrame {
	...
	public DeleteLibrarian() {
		...
		JLabel lblEnterId = new JLabel("Unesi ID bibliotekara:");
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(DeleteLibrarian.this,"Polje za ID ne može biti prazno");
				}else{
					int id=Integer.parseInt(sid);
					int i=LibrarianDao.delete(id);
					if(i>0){
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"Brisanje uspešno!");
					}else{
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"Došlo je do greške prilikom brisanja!");
					}
				}
			}
		});
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(57)
					.addComponent(idField, GroupLayout.PREFERRED_SIZE, 178, GroupLayout.PREFERRED_SIZE)
