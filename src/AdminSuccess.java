...
public class AdminSuccess extends JFrame {
	...
	public AdminSuccess() {
		...
		JLabel lblAdminSection = new JLabel("Admin Sekcija");
		...
		JButton btnViewLibrarian = new JButton("Pregled bibliotekara");
		...
		JButton btnDeleteLibrarian = new JButton("Ukloni bibliotekara");
