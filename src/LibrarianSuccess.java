...
public class LibrarianSuccess extends JFrame {
	...
	public LibrarianSuccess() {
		...
		JLabel lblLibrarianSection = new JLabel("Bibliotekarska sekcija");
		lblLibrarianSection.setFont(new Font("Tahoma", Font.PLAIN, 22));
		
		JButton btnNewButton = new JButton("Dodaj knjige");
		...
		JButton btnViewBooks = new JButton("Pregled knjiga");
		...
		JButton btnViewIssuedBooks = new JButton("Pregled izdatih knjiga");
		...
		JButton btnViewRequests = new JButton("Pregled zahteva");
		btnViewRequests.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewRequests.main(new String[]{});
			}
		});
		btnViewRequests.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
					...
					.addComponent(lblLibrarianSection, GroupLayout.PREFERRED_SIZE, 251, GroupLayout.PREFERRED_SIZE)
					.addGap(54))
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btnViewRequests, GroupLayout.PREFERRED_SIZE, 191, GroupLayout.PREFERRED_SIZE)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(btnViewRequests, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
